                    ...
                    {filteredRegistrations.length === 0 ? (
                      ...
                      filteredRegistrations.map((reg, idx) => (
                        ...
                        >
                          ...
                          <td className="p-4">
                            <span className={`text-[10px] px-2.5 py-1 rounded-full font-extrabold uppercase tracking-wider border ${reg.status === 'checked_in' ? 'bg-emerald-500/10 text-emerald-800 border-emerald-500/20' :
